<?php
  ...
  if(strtoupper($_SESSION['level']) != 'A'){  /* Jika Orang Yang Login Bukan Admin */
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
      ...
      $tambah_bahan_query = 
        "INSERT INTO tb_bahan (tanggal, nama, nama_supplier, alamat_supplier, jumlah, satuan, harga)
          VALUES ('$tanggal', '$nama', '$nama_supplier', '$alamat_supplier', '$jumlah', '$satuan', '$harga')";
      ...
      $transaksi_tambah_bahan_query =
        "INSERT INTO tb_transaksi (tanggal, id_user, type, id_produk, jumlah, debit, credit, keterangan, nama, alamat)
          VALUES ('$tanggal', '$id_user', '$type', '$id_bahan', '$jumlah', '$harga', 0, '$keterangan', '$nama_supplier', '$alamat_supplier')";
