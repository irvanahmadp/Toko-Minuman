...
(2, '2019-04-24 17:13:12', '0000-00-00 00:00:00', 'Teh Botol Sosro', 5000, 25, 'produk70320190424171312'),
...
(3, '2019-04-25 17:27:00', 'Akun Test', 'M', 'email@gmail.com', '123456789', 'fcea920f7412b5da7be0cf42b8c93759', '');
...
--
ALTER TABLE `tb_transaksi_beli`
  MODIFY `id_transaksi_beli` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tb_transaksi_jual`
--
ALTER TABLE `tb_transaksi_jual`
  MODIFY `id_transaksi_jual` int(10) NOT NULL AUTO_INCREMENT;
